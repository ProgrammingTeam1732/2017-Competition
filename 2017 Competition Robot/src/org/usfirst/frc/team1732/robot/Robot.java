...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		try {
			...
			dashboard.addItem(SmartDashboardItem.newDoubleReciever("Feeder Speed", -.5, feeder::setSpeed));
			dashboard.addItem(SmartDashboardItem.newDoubleReciever("Intake Speed", .8, ballIntake::setSpeed));
