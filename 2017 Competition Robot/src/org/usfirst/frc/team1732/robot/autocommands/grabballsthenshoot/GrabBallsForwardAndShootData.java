 ...
 *
 */
public class GrabBallsForwardAndShootData {
	static final double DRIVE_1_SETPOINT = 72;

	static final double TURN_1_ANGLE_RED = -90;
	static final double TURN_1_ANGLE_BLUE = -TURN_1_ANGLE_RED;

	static final double DRIVE_2_TIME = 2;

	static final double WAIT_1_TIME = 2;

	static final double DRIVE_3_SETPOINT = 10;
