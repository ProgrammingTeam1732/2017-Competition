...
public class SideTwoGearAuto extends CommandGroup {
	...
	DoubleSupplier leftDriveBackSetpoint1 = () -> -10 - Robot.driveTrain.leftEncoder.getTotalDistance();
	DoubleSupplier rightDriveBackSetpoint1 = () -> -10 - Robot.driveTrain.rightEncoder.getTotalDistance();
	...
	// drops gear intake
	boolean grabGearUseTimeout = false; // will use distance to end command
					    // if not grabbed
	...
	// drives back
	DoubleSupplier driveBackToGearPegLeftDistance = () -> -Robot.driveTrain.leftEncoder.getTotalDistance();
	DoubleSupplier driveBackToGearPegRightDistance = () -> -Robot.driveTrain.rightEncoder.getTotalDistance();
	addSequential(new DriveEncoders(driveBackToGearPegLeftDistance, driveBackToGearPegRightDistance));
