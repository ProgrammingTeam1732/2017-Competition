...
public class ThreeGearAuto extends CommandGroup {
	...
	DoubleSupplier firstGearScoreDriveBackLeft = () -> 60 - Robot.driveTrain.leftEncoder.getTotalDistance();
	DoubleSupplier firstGearScoreDriveBackRight = () -> 60 - Robot.driveTrain.rightEncoder.getTotalDistance();
	addSequential(
		new VisionPlaceGear(firstGearScoreDriveBackLeft, firstGearScoreDriveBackRight, maxSetpoint, true));
	...
	// drives back
	DoubleSupplier firstGearPickupReturnToGearPegLeft = () -> -Robot.driveTrain.leftEncoder.getTotalDistance();
	DoubleSupplier firstGearPickupReturnToGearPegRight = () -> -Robot.driveTrain.rightEncoder.getTotalDistance();
	addSequential(new DriveEncoders(firstGearPickupReturnToGearPegLeft, firstGearPickupReturnToGearPegRight));
	...
	// places the gear, drives back
	DoubleSupplier secondGearScoreDriveBackLeft = () -> 60 - Robot.driveTrain.leftEncoder.getTotalDistance();
	DoubleSupplier secondGearScoreDriveBackRight = () -> 60 - Robot.driveTrain.rightEncoder.getTotalDistance();
	addSequential(
		new VisionPlaceGear(secondGearScoreDriveBackLeft, secondGearScoreDriveBackRight, maxSetpoint, true));
	...
	// drives back
	DoubleSupplier secondGearPickupReturnToGearPegLeft = () -> -Robot.driveTrain.leftEncoder.getTotalDistance();
	DoubleSupplier secondGearPickupReturnToGearPegRight = () -> -Robot.driveTrain.rightEncoder.getTotalDistance();
	addSequential(new DriveEncoders(secondGearPickupReturnToGearPegLeft, secondGearPickupReturnToGearPegRight));
