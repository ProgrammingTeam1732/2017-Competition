...
public class KeylineHopperShootRed extends CommandGroup {
	...
	public KeylineHopperShootRed() {
		...
		addSequential(new DriveEncoders(KeylineHopperShootData.DRIVE_1_SETPOINT));
		addSequential(new TurnWithGyro(KeylineHopperShootData.TURN_1_ANGLE_RED));
		addSequential(new DriveEncoders(KeylineHopperShootData.DRIVE_3_SETPOINT));
		...
		addSequential(new DriveGyro(KeylineHopperShootData.TURN_3_TIME_RED, KeylineHopperShootData.DRIVE_LEFT_SPEED_RED,
