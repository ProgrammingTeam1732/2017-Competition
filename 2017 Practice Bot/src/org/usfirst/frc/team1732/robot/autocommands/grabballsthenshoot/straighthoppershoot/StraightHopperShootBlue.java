...
public class StraightHopperShootBlue extends CommandGroup {
	...
	public StraightHopperShootBlue() {
		...
		addSequential(
				new DriveTime(StraightHopperShootData.DRIVE_2_TIME, StraightHopperShootData.DRIVE_2_SPEED));

		addSequential(new Wait(StraightHopperShootData.WAIT_1_TIME));

		addSequential(
				new DriveTime(StraightHopperShootData.DRIVE_3_TIME, StraightHopperShootData.DRIVE_3_SPEED));
