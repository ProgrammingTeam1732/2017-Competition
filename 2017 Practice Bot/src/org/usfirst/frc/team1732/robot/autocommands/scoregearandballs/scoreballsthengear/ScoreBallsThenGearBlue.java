...
public class ScoreBallsThenGearBlue extends CommandGroup {
	...
	public ScoreBallsThenGearBlue() {
		...
		addSequential(new DriveEncoders(ScoreBallsThenGearData.DRIVE_1_SETPOINT, 0));

		// turn into boiler
		addSequential(new DriveGyro(ScoreBallsThenGearData.TURN_1_ANGLE_BLUE,
				ScoreBallsThenGearData.TURN_1_LEFT_SPEED_BLUE, ScoreBallsThenGearData.TURN_1_RIGHT_SPEED_BLUE));
		...
		addSequential(new DriveEncoders(ScoreBallsThenGearData.DRIVE_2_SETPOINT, 0));

		// turn to face peg
		addSequential(new DriveGyro(ScoreBallsThenGearData.TURN_2_ANGLE_BLUE,
				ScoreBallsThenGearData.TURN_2_LEFT_SPEED_BLUE, ScoreBallsThenGearData.TURN_2_RIGHT_SPEED_BLUE));
